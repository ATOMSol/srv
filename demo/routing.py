...
from .consumers import appointment_consumers,call_consumer,canteen_consumer,gm_visitor_consumer
...
websocket_urlpatterns = [
    ...
    re_path(r'^ws/gm_visitors/$', gm_visitor_consumer.AppointmentConsumer.as_asgi()),
